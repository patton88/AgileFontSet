...
#define WM_SETPAGEFOCUS17 WM_APP + 11//必须响应此消息才能调用OnSetPageFocus()禁用启用按钮
	...
	BEGIN_DLGRESIZE_MAP(PP1_FontSet)
		...
		DLGRESIZE_CONTROL(IDC_STATIC_VERNO, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_GROUP_ICONSPACING_SET, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_GROUP_FONTSET, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_ALLFONT, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_ALLFONT, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_ALLFONT, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_TITLE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_TITLE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_TITLE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_ICON, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_ICON, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_ICON, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_MENU, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_MENU, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_MENU, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_MESSAGE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_MESSAGE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_MESSAGE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_PALETTE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_PALETTE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_PALETTE, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_TIP, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_TIP, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDB_SEL_TIP, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_ICON_HS, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_HS, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_ICON_VS, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_EDIT_VS, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_COMBO_PRECONFIT, DLSZ_SIZE_X)
		DLGRESIZE_CONTROL(IDC_STATIC_PRECONFIT, DLSZ_SIZE_X)
	END_DLGRESIZE_MAP()
